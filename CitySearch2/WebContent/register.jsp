...
<body>
	...
	<div id="three-columns">
		<div id="column1">
			...
			<fieldset>
				<legend style="font-weight: bold; color: blue;">Registration
					Form</legend>
					...
					<tbody>
						...
						<tr>
							...
							<td>&nbsp;<input type="text" name="useremail"
								onkeyup="sendInfo()"><span id="location"></span></td>
						</tr>
						<tr>
							<td>&nbsp;Address:</td>
						...
						<tr>
							<td valign="top"><br></td>
							<td valign="top"><input type="submit" value="register"
								name="button1" onclick="sendInfo()"></td>
						</tr>
